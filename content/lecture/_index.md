...
- <a href="/lecture/correcting_structural_errors.ipynb" download="correcting_structural_errors.ipynb">Correcting Structural Errors (ipynb)</a>
- <a href="/lecture/Data_Loading_CSV.ipynb" download="Data_Loading_CSV.ipynb">Data Loading CSV (ipynb)</a>
- <a href="/lecture/fixing_data_types.ipynb" download="fixing_data_types.ipynb">Fixing Data Types (ipynb)</a>
- <a href="/lecture/handling_missing_data.ipynb" download="handling_missing_data.ipynb">Handling Missing Data (ipynb)</a>
- <a href="/lecture/I94_Traffic_BigDataViz_Demo.ipynb" download="I94_Traffic_BigDataViz_Demo.ipynb">I94 Traffic Big Data Viz Demo (ipynb)</a>
- <a href="/lecture/OpenMeteo_WeatherAPI_HandsOn.ipynb" download="OpenMeteo_WeatherAPI_HandsOn.ipynb">OpenMeteo Weather API Hands On (ipynb)</a>
- <a href="/lecture/outlier_detection_treatment.ipynb" download="outlier_detection_treatment.ipynb">Outlier Detection Treatment (ipynb)</a>
- <a href="/lecture/parsing_splitting_fields.ipynb" download="parsing_splitting_fields.ipynb">Parsing Splitting Fields (ipynb)</a>
- <a href="/lecture/partial_duplicates_challenge.ipynb" download="partial_duplicates_challenge.ipynb">Partial Duplicates Challenge (ipynb)</a>
- <a href="/lecture/pneumonia_project.ipynb" download="pneumonia_project.ipynb">Pneumonia Project (ipynb)</a>
- <a href="/lecture/poly_regression_visualizer.ipynb" download="poly_regression_visualizer.ipynb">Poly Regression Visualizer (ipynb)</a>
- <a href="/lecture/standardize_text_categories.ipynb" download="standardize_text_categories.ipynb">Standardize Text Categories (ipynb)</a>
- <a href="/lecture/SyntheticDigits_Augmentation.ipynb" download="SyntheticDigits_Augmentation.ipynb">Synthetic Digits Augmentation (ipynb)</a>
- <a href="/lecture/SyntheticHealthData_HandsOn.ipynb" download="SyntheticHealthData_HandsOn.ipynb">Synthetic Health Data Hands On (ipynb)</a>
- <a href="/lecture/validating_constraints.ipynb" download="validating_constraints.ipynb">Validating Constraints (ipynb)</a>
- <a href="/lecture/WebScraping_BooksToScrape.ipynb" download="WebScraping_BooksToScrape.ipynb">WebScraping Books To Scrape (ipynb)</a>
...
- <a href="/lecture/dim_reduction_digits.ipynb" download="dim_reduction_digits.ipynb">Dim Reduction Digits (ipynb)</a>
- <a href="/lecture/dim_reduction_wine.ipynb" download="dim_reduction_wine.ipynb">Dim Reduction Wine (ipynb)</a>
...
- <a href="/lecture/Movie_Analysis_Revised.ipynb" download="Movie_Analysis_Revised.ipynb">Movie Analysis Revised (ipynb)</a>
- <a href="/lecture/movie_cluster_data.csv" download="movie_cluster_data.csv">Movie Cluster Data (csv)</a>
- <a href="/lecture/task7_multivariate_visualization.ipynb" download="task7_multivariate_visualization.ipynb">Task7 Multivariate Visualization (ipynb)</a>
...
- <a href="/lecture/Clustering_measures.ipynb" download="Clustering_measures.ipynb">Clustering Measures (ipynb)</a>
- <a href="/lecture/Hierarchical_Clustering.ipynb" download="Hierarchical_Clustering.ipynb">Hierarchical Clustering (ipynb)</a>
- <a href="/lecture/K_means.ipynb" download="K_means.ipynb">K Means (ipynb)</a>
- <a href="/lecture/PCA.ipynb" download="PCA.ipynb">PCA (ipynb)</a>
- <a href="/lecture/Spectral_clustering.ipynb" download="Spectral_clustering.ipynb">Spectral Clustering (ipynb)</a>
- <a href="/lecture/tSNE.ipynb" download="tSNE.ipynb">tSNE (ipynb)</a>
...
- <a href="/lecture/Multiple_Testing.ipynb" download="Multiple_Testing.ipynb">Multiple Testing (ipynb)</a>
- <a href="/lecture/Rank-based_Tests.ipynb" download="Rank-based_Tests.ipynb">Rank-based Tests (ipynb)</a>
- <a href="/lecture/Simulation_Tests.ipynb" download="Simulation_Tests.ipynb">Simulation Tests (ipynb)</a>
...
- <a href="/lecture/L13-Ethics.pdf" download="L13-Ethics.pdf"> Ethics (pdf)</a>
...
- <a href="/lecture/Potential_Outcomes.ipynb" download="Potential_Outcomes.ipynb">Potential Outcomes (ipynb)</a>
